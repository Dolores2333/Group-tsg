...
"""
trainer() finishs the entire training loop and return the model
__loss_fn() return the loss function according to str: loss_name
"""
...
def trainer(snapshot_manager: SnapshotManager,
    ...
    for i in range(iteration + 1, iterations + 1):
        ...
        # print(f"The shape if forecast is {forecast.detach().numpy().shape}")
        # print(f"The shape of y is {y.detach().numpy().shape}")
        # print(f"The shape of y_mask of {y_mask.detach().numpy().shape}")
