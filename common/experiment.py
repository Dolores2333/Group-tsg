...
"""
instance() is abstractmethod
run() ————> instance()
build_ensemble() ————> build()
build()
1. build instance directories
2. build instance config
3. build instance command
"""
...
class Experiment(ABC):
    ...
    def build(self,
        ...
        for instance_values in tqdm(product(*ensemble_variables)):
            ...
            # write instance parameters info into cinfig
    ...
    '''
    Run instance() and mark experiment as finished
    '''
    def run(self):
        """
        Run instance logic.
